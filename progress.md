...
Chart PHP Parity - Created ChartColor, Title, Legend, Axis, PlotArea, GridLines, TrendLine classes. Fixed DataSeries architecture. Added trend lines read/write support with full test coverage.
