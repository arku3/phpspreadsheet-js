...
Chart PHP Parity - Created ChartColor, Title, Legend, Axis, PlotArea, GridLines, TrendLine classes. Fixed DataSeries architecture. Added trend lines read/write support. Added axis scaling (logarithmic, min/max) to chart writer.
