...
export class DateValue extends WizardAbstract implements WizardInterface {
    ...
    public yesterday(): this { return this.setOperator(Conditional.TIMEPERIOD_YESTERDAY); }
    public today(): this { return this.setOperator(Conditional.TIMEPERIOD_TODAY); }
    public tomorrow(): this { return this.setOperator(Conditional.TIMEPERIOD_TOMORROW); }
    public lastSevenDays(): this { return this.setOperator(Conditional.TIMEPERIOD_LAST_7_DAYS); }
    public last7Days(): this { return this.setOperator(Conditional.TIMEPERIOD_LAST_7_DAYS); }
    public lastWeek(): this { return this.setOperator(Conditional.TIMEPERIOD_LAST_WEEK); }
    public thisWeek(): this { return this.setOperator(Conditional.TIMEPERIOD_THIS_WEEK); }
    public nextWeek(): this { return this.setOperator(Conditional.TIMEPERIOD_NEXT_WEEK); }
    public lastMonth(): this { return this.setOperator(Conditional.TIMEPERIOD_LAST_MONTH); }
    public thisMonth(): this { return this.setOperator(Conditional.TIMEPERIOD_THIS_MONTH); }
    public nextMonth(): this { return this.setOperator(Conditional.TIMEPERIOD_NEXT_MONTH); }
