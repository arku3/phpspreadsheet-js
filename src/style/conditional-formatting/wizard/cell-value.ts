...
export class CellValue extends WizardAbstract implements WizardInterface {
    ...
    public greaterThanOrEqual(value: number | string | boolean, operandValueType: string = Wizard.VALUE_TYPE_LITERAL): this {
    ...
    public lessThanOrEqual(value: number | string | boolean, operandValueType: string = Wizard.VALUE_TYPE_LITERAL): this {
    ...
    protected setOperand(index: number, operand: number | string | boolean, operandValueType: string = Wizard.VALUE_TYPE_LITERAL): void {
