...
export class Theme extends WriterPart {
    ...
    public writeTheme(spreadsheet: Spreadsheet): string {
        ...
        gsLst1.ele('a:gs', { pos: '0' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:tint', { val: '50000' }).up().ele('a:satMod', { val: '300000' });
        gsLst1.ele('a:gs', { pos: '35000' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:tint', { val: '37000' }).up().ele('a:satMod', { val: '300000' });
        gsLst1.ele('a:gs', { pos: '100000' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:tint', { val: '15000' }).up().ele('a:satMod', { val: '350000' });
        ...
        gsLst2.ele('a:gs', { pos: '0' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:shade', { val: '51000' }).up().ele('a:satMod', { val: '130000' });
        gsLst2.ele('a:gs', { pos: '80000' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:shade', { val: '93000' }).up().ele('a:satMod', { val: '130000' });
        gsLst2.ele('a:gs', { pos: '100000' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:shade', { val: '94000' }).up().ele('a:satMod', { val: '135000' });
        ...
        ln1.ele('a:solidFill').ele('a:schemeClr', { val: 'phClr' }).ele('a:shade', { val: '95000' }).up().ele('a:satMod', { val: '105000' });
        ...
        effectStyleLst.ele('a:effectStyle').ele('a:effectLst').ele('a:outerShdw', { blurRad: '40000', dist: '20000', dir: '5400000', rotWithShape: '0' }).ele('a:srgbClr', { val: '000000' }).ele('a:alpha', { val: '38000' });
        effectStyleLst.ele('a:effectStyle').ele('a:effectLst').ele('a:outerShdw', { blurRad: '40000', dist: '23000', dir: '5400000', rotWithShape: '0' }).ele('a:srgbClr', { val: '000000' }).ele('a:alpha', { val: '35000' });
        
        const effectStyle3 = effectStyleLst.ele('a:effectStyle');
        effectStyle3.ele('a:effectLst').ele('a:outerShdw', { blurRad: '40000', dist: '23000', dir: '5400000', rotWithShape: '0' }).ele('a:srgbClr', { val: '000000' }).ele('a:alpha', { val: '35000' });
        effectStyle3.ele('a:scene3d').ele('a:camera', { prst: 'orthographicFront' }).ele('a:rot', { lat: '0', lon: '0', rev: '0' }).up().up().ele('a:lightRig', { rig: 'threePt', dir: 't' }).ele('a:rot', { lat: '0', lon: '0', rev: '1200000' });
        ...
        bgGsLst1.ele('a:gs', { pos: '0' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:tint', { val: '40000' }).up().ele('a:satMod', { val: '350000' });
        bgGsLst1.ele('a:gs', { pos: '40000' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:tint', { val: '45000' }).up().ele('a:shade', { val: '99000' }).up().ele('a:satMod', { val: '350000' });
        bgGsLst1.ele('a:gs', { pos: '100000' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:shade', { val: '20000' }).up().ele('a:satMod', { val: '255000' });
        bgGradFill1.ele('a:path', { path: 'circle' }).ele('a:fillToRect', { l: '50000', t: '-80000', r: '50000', b: '180000' });

        const bgGradFill2 = bgFillStyleLst.ele('a:gradFill', { rotWithShape: '1' });
        const bgGsLst2 = bgGradFill2.ele('a:gsLst');
        bgGsLst2.ele('a:gs', { pos: '0' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:tint', { val: '80000' }).up().ele('a:satMod', { val: '300000' });
        bgGsLst2.ele('a:gs', { pos: '100000' }).ele('a:schemeClr', { val: 'phClr' }).ele('a:shade', { val: '30000' }).up().ele('a:satMod', { val: '200000' });
        bgGradFill2.ele('a:path', { path: 'circle' }).ele('a:fillToRect', { l: '50000', t: '50000', r: '50000', b: '50000' });
